            ...
            <div id="test">
                <div class="test1">
                    ...
                    <div class="login-infor">
                            ...
                            ?>
                        <form class="form-sign-in" action="add.admin.inc.php" method="POST">
                            <label class="form-field">Admin Name*</label>
                            <input type="text" name="name" class="input-field" required>
                            <label class="form-field">Admin Email*</label>
                            <input type="email" name="email" class="input-field" required>
                            <label class="form-field">Admin ID*</label>
