        ...
        <div class="admin-content">
            ...
            <div id="test"> 
                <div class="test1">
                    ...
                    <h1 class="create">UPDATE AN PRODUCT</h1>

                    <div class="login-infor">
                    <form class="form-sign-in" action="edit-update.php?id=<?php echo $id ?>&image=<?php echo $image ?>" method="post" enctype="multipart/form-data">
                        <div>
