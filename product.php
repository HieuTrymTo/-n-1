...
<body>
    ...
    <div class="product-card">
        <?php
            ...
            $sql = "SELECT * FROM product ORDER BY productsOrder DESC LIMIT $start,$num_per_page ";
            $stmt = mysqli_stmt_init($conn);
            if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            <div id="custom-select"> 
                ...
                if ($page == floor($totalpage) && floor($totalpage)> 1) {
                    ?>
                        <a href="product.php?page=<?php echo $pagePrev?>">Prev</a>
                        <div class="optionvalue">
                            <select onchange="location = this.value;">
                                <?php
                                for ($i = 1; $i <= $totalpage; $i++) {
                                    echo "<option class='choice' value=product.php?page=".$i.">$i</option>";
                                }
                                ?>
                            </select>
                    ...
                    ?>
                        ...
                        <a href="product.php?page=<?php echo $pageNext?>">Next</a>
                    <?php
    ...
    <script>  
        $("div.optionvalue select").val("product.php?page=<?php echo $page;?>");
    </script>
